    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MajorGods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MajorGods_Pantheons_PantheonId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PantheonId = table.Column<int>(type: "int", nullable: false),
                    MajorGodId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Builds_MajorGods_MajorGodId",
                        column: x => x.MajorGodId,
                        principalTable: "MajorGods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildTag", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BuildId = table.Column<int>(type: "int", nullable: false),
                    Minute = table.Column<TimeOnly>(type: "time", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MajorGods_PantheonId",
                table: "MajorGods",
                column: "PantheonId");

            migrationBuilder.CreateIndex(
                name: "IX_Steps_BuildId",
                table: "Steps",
                column: "BuildId");
